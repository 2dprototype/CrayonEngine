...
function crayon.init()
    ...
    crayon.window.setTitle("Crayon Engine - 3D Hierarchical Transforms")
    ...
    crayon.graphics.setRetroEffects({
        ...
        affine = 1.0,
        dither = true,
        fog = { startDist = 6, endDist = 18, color = {0.1, 0.12, 0.18} }
    })

    crayon.graphics.setLight(-0.5, -1.0, -0.3, 1.0, 0.95, 0.85, 0.25, 0.25, 0.3)
end
...
function crayon.draw()
    ...
    -- Central Pedestal
    crayon.graphics.drawModel(cyl_model, 0, -1.0, 0, 0, 0, 0, 1.5, 2.0, 1.5, brick_tex)
    ...
    crayon.graphics.drawModel(cube_model, 0, 0, 0, 0, 0, 0, 1.2, 1.2, 1.2, crate_tex)

    -- Satellite Orbit 1
    crayon.graphics.pushMatrix()
    crayon.graphics.rotate(rad * 2.0, 0, 1, 0)
    crayon.graphics.translate(2.5, 0, 0)
    crayon.graphics.drawModel(sphere_model, 0, 0, 0, 0, 0, 0, 0.6, 0.6, 0.6, brick_tex)

    -- Moon Orbit around Satellite 1
    crayon.graphics.rotate(rad * 4.0, 1, 0, 0)
    crayon.graphics.translate(0, 0.9, 0)
    crayon.graphics.drawModel(cube_model, 0, 0, 0, 0, 0, 0, 0.3, 0.3, 0.3, crate_tex)
    ...
    crayon.graphics.drawModel(cube_model, 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, crate_tex)
    crayon.graphics.popMatrix()
